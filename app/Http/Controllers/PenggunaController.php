...
class PenggunaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pengguna.daftar', compact('daftarPengguna', 'daftarPeran', 'kataKunci', 'peran'));
    }
    ...
    public function destroy(User $pengguna)
    {
        ...
        if ($pengguna->peminjamanDiajukan()->exists()) {
            return redirect()
                ->route('pengguna.index')
                ->with('gagal', 'Pengguna tidak dapat dihapus karena memiliki riwayat peminjaman. Nonaktifkan akunya sebagai gantinya.');
        }
