            ...
            <div class="card">
                ...
                <div class="card-body">
                    <dl class="row small mb-0">
                        ...
                        <dd class="col-7">{{ $pengembalian->peminjaman->peminjam->nama }}</dd>

                        <dt class="col-5">Tanggal Kembali</dt>
                        <dd class="col-7">{{ $pengembalian->tgl_kembali->format('d/m/Y') }}</dd>

                        <dt class="col-5">Hari Terlambat</dt>
                        <dd class="col-7">{{ $pengembalian->hari_terlambat }} hari</dd>

                        <dt class="col-5">Denda Keterlambatan</dt>
                        <dd class="col-7">Rp {{ number_format($pengembalian->denda, 0, ',', '.') }}</dd>

                        <dt class="col-5">Total Denda</dt>
                        <dd class="col-7">Rp {{ number_format($pengembalian->total_denda, 0, ',', '.') }}</dd>
                    </dl>
                    <hr>
