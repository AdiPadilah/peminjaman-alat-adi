        ...
        <div class="row">
            <div class="col-md-8 mb-3">
                ...
                <div class="alert alert-info mt-3 mb-0 small">
                    Alat berkondisi <strong>baik</strong> dan <strong>rusak ringan</strong> kembali menambah stok tersedia.
                    Alat berkondisi <strong>rusak berat</strong> dan <strong>hilang</strong> mengurangi stok total.
                </div>
            </div>
